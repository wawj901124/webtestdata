...
if __name__ == "__main__":
    outdevice = "TWP6R20821001328"
    apppacakagename = "com.android.contacts"
    activityname = ".activities.PeopleActivity"
    # "com.android.settings/.HWSettings"
    #
    bf = BaseFrame(outdevice=outdevice)
    # bf.install_uiaumator2_yilai()
    # # # bf.findbytext_and_click(outpretoastmessage='',text="Show QR")
    dv = bf.getdeviceinfo()
    bf.startapp(packagename=apppacakagename,activityname=activityname)
    resourceId = "com.android.contacts:id/text_no_contacts"
    findstyle = "resourceId"
    styleparame = "com.android.contacts:id/text_no_contacts"
    bf.findelement(findstyle, styleparame)
    ...
    # pass
    # import uiautomator2 as u2
    # d = u2.connect_usb("XPL5T20618001379")
    # print(d.info)
