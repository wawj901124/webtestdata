from TestCaseFunction.autotest.test.marketing.rwhdgl.AutoTestEditTicket import TestEditTicketClass
def caselist():
    alltestnames = [
        ...
        'TestCaseFunction.autotest.test.marketing.rwhdgl.AutoTestEditTicket.TestEditTicketClass',
