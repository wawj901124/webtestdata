...
def caselist():
    alltestnames = [
        ...
        'TestCaseFunction.autotest.test.marketing.yyhdglxw.AutoTestEditActivity.TestEditActivityClass',
        'TestCaseFunction.autotest.test.marketing.yyhdglxw.AutoTestEditTicket.TestEditTicketClass',
        'TestCaseFunction.autotest.test.marketing.yyhdglxw.AutoTestHighLinesActivity.TestHighLinesActivityClass',
        'TestCaseFunction.autotest.test.marketing.yyhdglxw.AutoTestEditProcessingActivity.TestEditProcessingActivityClass',
        'TestCaseFunction.autotest.test.marketing.yyhdglxw.AutoTestDownLinesActivity.TestDownLinesActivityClass'
