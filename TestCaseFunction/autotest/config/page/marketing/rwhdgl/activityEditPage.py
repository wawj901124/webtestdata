...
class ActivityEditPage:
    ...
    if ISONLINE:
        pageurl = "%s/nereus/marketing/admin/v/#/activityManage/missionAct/modifyOnLine/%s" % (ONLINE_WEB_URL_TITLE,editactivityid )
    else:
        pageurl = "%s/nereus/marketing/admin/v/#/activityManage/missionAct/modifyOnLine/%s" % (TEST_WEB_URL_TITLE, editactivityid)
    ...
    hdsj = ""
    hdsj_text = u"活动时间"
    hdsj_starttime = "/html/body/div[1]/div/div[2]/div[2]/div/div/div[1]/div/form/div[1]/div[1]/div[2]/div/div[3]/div/div[1]/div[1]/div/input"
