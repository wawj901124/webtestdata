...
class ActivityListPage:
    if ISONLINE:
        pageurl = "%s/nereus/marketing/admin/v/#/activityManage/missionAct/list" % ONLINE_WEB_URL_TITLE
    else:
        pageurl = "%s/nereus/marketing/admin/v/#/activityManage/missionAct/list" % TEST_WEB_URL_TITLE
