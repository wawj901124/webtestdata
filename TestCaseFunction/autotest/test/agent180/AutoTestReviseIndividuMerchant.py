...
class TestReviseMerchantClass(unittest.TestCase):  # 创建测试类
    ...
    #定义搜索查找函数
    def definerevisemerchantindividu(self, num, isfictitious=False,brandnameinputtext=None, emailinputtext=None, contactnumberinputtext=None,  #添加个人商户
    ...
    def getTestFunc( num, isfictitious,brandnameinputtext, emailinputtext, contactnumberinputtext,  #添加个人商户
        ...
        def func(self):
            self.definerevisemerchantindividu(num, isfictitious,brandnameinputtext, emailinputtext, contactnumberinputtext,  #添加个人商户
                          merchanttypeselectoptionxpath, categoryselectoptionxpath, criteriaselectoptionxpath,
                          siupinputtext, provinceselectoptionxpath, cityselectoptionxpath,
                          districtinputtext, villageinputtext, postcodeinputtext,addressinputtext,
                          photosiupimagefilepath, photonpwpcompanyimagefilepath, phototdpimagefilepath,
...
def __generateTestCases():
    ...
    for addmerchant in addmerchant_all:
        ...
        setattr(TestReviseMerchantClass, 'test_func_%s_%s' % (addmerchantid,addmerchant.testcasetitle),
                TestReviseMerchantClass.getTestFunc(*args))  # 通过setattr自动为TestCase类添加成员方法，方法以“test_func_”开头
