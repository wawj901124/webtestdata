...
from TestCaseFunction.autotest.config.page.agent180.reviseCompanyMerchantPage import ReviseCompanyMerchantPage
...
class TestReviseCompanyMerchantClass(unittest.TestCase):  # 创建测试类
    ...
    def setUp(self):  # 每条用例执行测试之前都要执行此方法
        ...
        self.testpage = ReviseCompanyMerchantPage()
    ...
    # 定义搜索查找函数
    def definerevisemerchantcompany(self, num, isfictitious=False, brandnameinputtext=None, emailinputtext=None,
                                 contactnumberinputtext=None,  # 添加公司商户
                                 merchanttypeselectoptionxpath=None, categoryselectoptionxpath=None,
                                 criteriaselectoptionxpath=None,
                                 siupinputtext=None, provinceselectoptionxpath=None, cityselectoptionxpath=None,
                                 districtinputtext=None, villageinputtext=None, postcodeinputtext=None,
                                 addressinputtext=None,
                                 companynameinputtext=None, officialwebsiteinputtext=None, npwptaxidinputtext=None,
                                 # 新加
                                 photosiupimagefilepath=None, photonpwpcompanyimagefilepath=None,
                                 ...
                                 locationphotoimagefilepath=None, photoofthecashiersdeskimagefilepath=None,
        ...
        # 添加公司商户
        # 添加Basic info
        self.activeweb.findElementByXpathAndInputNum(num, self.testpagebrandnameinput,
        ...
        # 添加Merchant info
        self.activeweb.findElementByXpathAndClickOptionXpathNum(num, self.testpagemerchanttypeselect,
                                                                merchanttypeselectoptionxpath)  # 选择Merchant type
        self.activeweb.findElementByXpathAndClickOptionXpathNum(num, self.testpagecategoryselect,
                                                                categoryselectoptionxpath)  # 选择Category
        if criteriaselectoptionxpath != None:
            self.activeweb.findElementByXpathAndClickOptionXpathNum(num, self.testpagecriteriaselect,
                                                                    criteriaselectoptionxpath)  # 选择Criteria
        if provinceselectoptionxpath != None:
            self.activeweb.findElementByXpathAndClickOptionXpathNum(num, self.testpageprovinceselect,
                                                                    provinceselectoptionxpath)  # 选择Province
        if cityselectoptionxpath != None:
            self.activeweb.findElementByXpathAndClickOptionXpathNum(num, self.testpagecityselect,
                                                                    cityselectoptionxpath)  # 选择City
        if districtinputtext != None:
            self.activeweb.findElementByXpathAndInputNum(num, self.testpagedistrictinput,
        ...
        if postcodeinputtext != None:
            self.activeweb.findElementByXpathAndInputNum(num, self.testpagepostcodeinput,
        ...
        if companynameinputtext != None:
            self.activeweb.findElementByXpathAndInputNum(num, self.testpagecompanynameinput,
                                                         companynameinputtext)  # 输入Company name   #新加
        if officialwebsiteinputtext != None:
            self.activeweb.findElementByXpathAndInputNum(num, self.testpageofficialwebsiteinput,
                                                         officialwebsiteinputtext)  # 输入Official Website   #新加
        if npwptaxidinputtext != None:
            self.activeweb.findElementByXpathAndInputNum(num, self.testpagenpwptaxidinput,
                                                         npwptaxidinputtext)  # 输入NPWP/TAX ID   #新加
        if photonpwpcompanyimagefilepath != None:
            self.activeweb.findElementByXpathAndAndFileNumVue(num, self.testpagephotonpwpcompanyimage,
                                                              photonpwpcompanyimagefilepath)  # 添加Photo NPWP Company图片   #更换
        if phototdpimagefilepath != None:
            self.activeweb.findElementByXpathAndAndFileNumVue(num, self.testpagephototdpimage,
        ...
        self.activeweb.findElementByXpathAndScriptClickNum(num,
                                                           self.testpageownerpersoninchargeinfo)  # 点击Owner / Person in Charge info
        ...
        if positioninputtext != None:
            self.activeweb.findElementByXpathAndInputNum(num, self.testpagepositioninput,
        ...
        if email2inputtext != None:
            self.activeweb.findElementByXpathAndInputNum(num, self.testpageemail2input,
                                                         email2inputtext)  # 输入Email   #更换
        self.activeweb.findElementByXpathAndAndFileNumVue(num, self.testpagephotofullfacebustimage,
        ...
        # 添加Profile Photos
        self.activeweb.findElementByXpathAndAndFileNumVue(num, self.testpagelocationphotoimage,
                                                          locationphotoimagefilepath)  # 添加Location Photo图片
        if photoofthecashiersdeskimagefilepath != None:
            self.activeweb.findElementByXpathAndAndFileNumVue(num, self.testpagephotoofthecashiersdeskimage,
                                                              photoofthecashiersdeskimagefilepath)  # 添加Photo of the cashiers desk图片
        if otherphotoimagefilepath != None:
            self.activeweb.findElementByXpathAndAndFileNumVue(num, self.testpageotherphotoimage,
        ...
        # 添加Bank account
        self.activeweb.findElementByXpathAndClickOptionXpathNum(num, self.testpagebankselect,
                                                                bankselectoptionxpath)  # 选择Bank
        self.activeweb.findElementByXpathAndInputNum(num, self.testpageaccountnameinput,
                                                     accountnameinputtext)  # 输入Account name
        self.activeweb.findElementByXpathAndInputNum(num, self.testpageaccountnumberinput,
        ...
        # 点击submit again按钮
        self.activeweb.findElementByXpathAndClickNum(num, self.testpagesubmitagainbutton)  # 点击submit again按钮
        ...
        self.defineasserttextnum(num, AddMerchantDonePage().waitingforapproval,
        ...
        merchantid = self.activeweb.findElementByXpathAndReturnText(num,
        ...
        self.defineassertdetailstextnum(num, CompanyDetailsPage().merchanttypevalue,
        ...
        if criteriaselectoptionxpath != None:
            self.defineassertdetailstextnum(num, CompanyDetailsPage().criteriavalue,
        ...
        if provinceselectoptionxpath != None:
            self.defineassertdetailstextnum(num, CompanyDetailsPage().provincevalue,
        ...
        # 断言存在Company name
        self.defineassertdetailstextnum(num, CompanyDetailsPage().companyname,
        ...
        self.defineassertdetailstextnum(num, CompanyDetailsPage().officialwebsite,
                                        CompanyDetailsPage().officialwebsitetext)  # 公司专有
        if officialwebsiteinputtext != None:
            self.defineassertdetailstextnum(num, CompanyDetailsPage().officialwebsitevalue,
        ...
        self.defineassertdetailstextnum(num, CompanyDetailsPage().photonpwpcompany,
        ...
        self.defineassertdetailstextnum(num, CompanyDetailsPage().ownerpersoninchangeinfo,
        ...
        self.defineassertdetailstextnum(num, CompanyDetailsPage().photofullfacebust,
        ...
        self.defineassertdetailstextnum(num, CompanyDetailsPage().photoofthecashiersdesk,
    ...
    def getTestFunc(num, isfictitious, brandnameinputtext, emailinputtext, contactnumberinputtext,  # 添加公司商户
        ...
        def func(self):
            self.definerevisemerchantcompany(num, isfictitious, brandnameinputtext, emailinputtext, contactnumberinputtext,
                                          # 添加公司商户
                                          merchanttypeselectoptionxpath, categoryselectoptionxpath,
                                          ...
                                          locationphotoimagefilepath, photoofthecashiersdeskimagefilepath,
...
def __generateTestCases():
    ...
    for addmerchant in addmerchant_all:
        ...
        setattr(TestReviseCompanyMerchantClass, 'test_func_%s_%s' % (addmerchantid, addmerchant.testcasetitle),
                TestReviseCompanyMerchantClass.getTestFunc(*args))  # 通过setattr自动为TestCase类添加成员方法，方法以“test_func_”开头
