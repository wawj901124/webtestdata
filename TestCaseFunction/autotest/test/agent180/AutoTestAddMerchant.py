...
from autotest.config.page.agent180.addMerchantPage import AddMerchantPage
from autotest.config.page.agent180.addMerchantSuccessPage import AddMerchantSuccessPage
from autotest.config.page.agent180.addMerchantDonePage import AddMerchantDonePage
