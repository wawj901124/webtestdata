...
from .models import  ProcessActivity


class ProcessActivityAdmin(object):
    ...
    list_display =['id','testproject', 'testmodule','testpage','testcasetitle',
                   'zjysinputtext', 'ffzt', 'zjkcinputtext', 'isqcancel','iscancel','add_time','update_time']#定义显示的字段
...
xadmin.site.register(ProcessActivity, ProcessActivityAdmin) #在xadmin中注册AddTicket
