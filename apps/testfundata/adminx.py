...
class TestSearchAdmin(object):
    ziduan = ['is_cookie','modulepage','select_option_xpath','select_option_text','select_input_xpath','select_input_text','search_button_xpath','search_table_result_xpath','colnum','check_text']

    list_display =['id','is_cookie','modulepage','select_option_xpath','select_option_text','select_input_xpath','select_input_text','search_button_xpath','search_table_result_xpath','colnum','check_text','add_time','go_to']#定义显示的字段

    # list_display =[ 'test_project','test_module',
    #                 'case_title',
    #           ] #定义显示的字段
    search_fields =  ['is_cookie','modulepage','select_option_xpath','select_option_text','select_input_xpath','select_input_text','search_button_xpath','search_table_result_xpath','colnum','check_text',]   #定义搜索字段
    list_filter =  ['is_cookie','modulepage','select_option_xpath','select_option_text','select_input_xpath','select_input_text','search_button_xpath','search_table_result_xpath','colnum','check_text',] #定义筛选的字段
...
xadmin.site.register(TestSearch, TestSearchAdmin) #在xadmin中注册TestSearch
