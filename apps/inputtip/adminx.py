...
from .models import  InputTipData


class InputTipDataAdmin(object):
    ziduan = [ 'testproject','testmodule','testpage',
               'testcasetitle',
...
xadmin.site.register(InputTipData, InputTipDataAdmin) #在xadmin中注册InputTipData
