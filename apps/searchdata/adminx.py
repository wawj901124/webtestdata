...
class SearchDataAdmin(object):
    ziduan = ['webproject','testpage','testcasetitle','isclicklastpage','selectxpath','selectoptiontextxpath','selectinputxpath','selectinputselectonexpath','selectinputtext',
              'isfind','colnum','checktext']

    list_display =['id','webproject','testpage','testcasetitle','isclicklastpage','selectxpath','selectoptiontextxpath','selectinputxpath','selectinputselectonexpath','selectinputtext',
