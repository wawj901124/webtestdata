...
class AddMerchant(models.Model):
    ...
    companynameinputtext = models.CharField(max_length=100, default="", null=True, blank=True,verbose_name=u"输入Company name的内容_公司商户")
    officialwebsiteinputtext = models.CharField(max_length=100, default="", null=True, blank=True,verbose_name=u"输入Official Website的内容_公司商户")
    npwptaxidinputtext = models.CharField(max_length=100, default="", null=True, blank=True,verbose_name=u"输入NPWP/TAX ID的内容_公司商户")
    ...
    positioninputtext = models.CharField(max_length=100, default="", null=True, blank=True,verbose_name=u"输入Position的内容_公司商户")
    npwpinputtext = models.CharField(max_length=100, default="", null=True, blank=True,verbose_name=u"输入NPWP的内容_个人商户")
    typeidselectoptionxpath = models.CharField(max_length=1000, default="",null=True, blank=True, verbose_name=u"Type ID选项内容Xpath路径_个人商户")
    identitynumberinputtext = models.CharField(max_length=100, default="", null=True, blank=True,verbose_name=u"输入Identity number的内容_个人商户")
    address2inputtext = models.CharField(max_length=100, default="", null=True, blank=True,verbose_name=u"输入Address的内容_个人商户")
    nationalityselectoptionxpath = models.CharField(max_length=1000, default="",null=True, blank=True, verbose_name=u"Nationality选项内容Xpath路径_个人商户")
