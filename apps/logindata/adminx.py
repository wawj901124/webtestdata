...
class LoginDataAdmin(object):
    ziduan = ['webproject','testcasetitle','accountinput','passwordinput','vercodeinput',
              'assertaccounttiptext','assertpasswordtiptext','assertvercodetiptext','assertlogintiptext']

    list_display =['id','webproject','testcasetitle','accountinput','passwordinput','vercodeinput',
                   'assertaccounttiptext','assertpasswordtiptext','assertvercodetiptext','assertlogintiptext','add_time']#定义显示的字段
...
xadmin.site.register(LoginData, LoginDataAdmin) #在xadmin中注册LoginData
